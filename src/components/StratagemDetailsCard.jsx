  ...
  return (
    <>
      {!toggleEdit && ( // Render only if toggleEdit is false
        <div className="flex flex-col items-center md:flex-row w-[80vw] h-[80vh] bg-white border border-gray-200 rounded-lg shadow dark:bg-stone-700 dark:border-gray-700">
          <img
          ...
          <div className="flex flex-col p-4 items-center leading-normal w-full md:w-[75%]">
            ...
            <p className="mb-3 font-Insignia Regular text-gray-700 dark:text-gray-400">
              ...
              <br />
              <span className="font-semibold">Amount:</span> {stratagem.amount}{" "}
              <br />
